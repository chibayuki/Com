...
namespace Com
{
    ...
    public struct Complex : IEquatable<Complex>, IComparable, IComparable<Complex>
    {
        ...
        public static bool operator <(Complex left, Complex right) => left.Module < right.Module;
        ...
        public static Complex operator +(Complex comp) => comp;
        ...
        public static Complex operator -(Complex comp) => new Complex(-comp._Real, -comp._Imaginary);
        ...
        public static Complex operator +(Complex left, Complex right) => new Complex(left._Real + right._Real, left._Imaginary + right._Imaginary);
        ...
        public static Complex operator +(Complex left, double right) => new Complex(left._Real + right, left._Imaginary);
        ...
        public static Complex operator +(double left, Complex right) => new Complex(left + right._Real, right._Imaginary);
        ...
        public static Complex operator *(Complex left, Complex right) => new Complex(left._Real * right._Real - left._Imaginary * right._Imaginary, left._Imaginary * right._Real + left._Real * right._Imaginary);
        ...
        public static Complex operator *(Complex left, double right) => new Complex(left._Real * right, left._Imaginary * right);
        ...
        public static Complex operator *(double left, Complex right) => new Complex(left * right._Real, left * right._Imaginary);
        ...
        public static explicit operator PointD(Complex comp) => comp.ToPointD();
