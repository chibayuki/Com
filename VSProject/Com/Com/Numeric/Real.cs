...
namespace Com
{
    ...
    public struct Real : IEquatable<Real>, IComparable, IComparable<Real>
    {
        ...
        /// <returns>布尔值，表示两个 Real 结构是否相等。</returns>
        public static bool operator ==(Real left, Real right) => left._Magnitude == right._Magnitude && left._Value == right._Value;
        ...
        public static Real operator +(Real real) => real;
        ...
        public static explicit operator Real(decimal value) => new Real(value);
        ...
        /// <returns>Real 结构，表示隐式转换的结果。</returns>
        public static implicit operator Real(ulong value) => new Real(value);
        ...
        /// <returns>Real 结构，表示隐式转换的结果。</returns>
        public static implicit operator Real(long value) => new Real(value);
        ...
        /// <returns>Real 结构，表示隐式转换的结果。</returns>
        public static implicit operator Real(uint value) => new Real(value);
        ...
        /// <returns>Real 结构，表示隐式转换的结果。</returns>
        public static implicit operator Real(ushort value) => new Real(value);
        ...
        /// <returns>Real 结构，表示隐式转换的结果。</returns>
        public static implicit operator Real(short value) => new Real(value);
        ...
        /// <returns>Real 结构，表示隐式转换的结果。</returns>
        public static implicit operator Real(byte value) => new Real(value);
        ...
        /// <returns>Real 结构，表示隐式转换的结果。</returns>
        public static implicit operator Real(sbyte value) => new Real(value);
