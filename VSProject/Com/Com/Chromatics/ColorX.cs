...
namespace Com
{
    ...
    public struct ColorX : IEquatable<ColorX>
    {
        ...
        private static double _CheckGreenRed(double greenRed)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(greenRed));
            }
        ...
        private static double _CheckBlueYellow(double blueYellow)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(blueYellow));
            }
        ...
        private static double _CheckChrominanceBlue(double chrominanceBlue)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(chrominanceBlue));
            }
        ...
        private static double _CheckChrominanceRed(double chrominanceRed)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(chrominanceRed));
            }
        ...
        public override string ToString()
        {
            ...
            switch (_CurrentColorSpace)
            {
                case _ColorSpace.RGB: str = $"A={Alpha}, R={_Channel1}, G={_Channel2}, B={_Channel3}"; break;
                case _ColorSpace.HSV: str = $"H={_Channel1}, S={_Channel2}, V={_Channel3}, Opacity={Opacity}%"; break;
                case _ColorSpace.HSL: str = $"H={_Channel1}, S={_Channel2}, L={_Channel3}, Opacity={Opacity}%"; break;
                case _ColorSpace.CMYK: str = $"C={_Channel1}, M={_Channel2}, Y={_Channel3}, K={_Channel4}, Opacity={Opacity}%"; break;
                case _ColorSpace.LAB: str = $"L={_Channel1}, a={_Channel2}, b={_Channel3}, Opacity={Opacity}%"; break;
                case _ColorSpace.YUV: str = $"Y={_Channel1}, U={_Channel2}, V={_Channel3}, Opacity={Opacity}%"; break;
        ...
        public static explicit operator Color(ColorX color) => color.ToColor();
        ...
        public static implicit operator ColorX(Color color) => new ColorX(color);
