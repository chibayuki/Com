...
namespace Com
{
    ...
    /// </summary>
    public struct PointD5D : IEquatable<PointD5D>, IComparable, IComparable<PointD5D>, IEuclideanVector<PointD5D>, IAffineTransformable<PointD5D>, IAffine<PointD5D>
    {
        #region 非公开成员
        ...
        {
            if (obj is null || !(obj is PointD5D))
            {
                return false;
            }
            else
        ...
        public override string ToString() => $"{{X={_X}, Y={_Y}, Z={_Z}, U={_U}, V={_V}}}";
        ...
        public PointD5D ToSpherical() => FromVector(ToColumnVector().ToSpherical());
        ...
        public PointD5D ToCartesian() => FromVector(ToColumnVector().ToCartesian());
        ...
        public PointD5D OffsetCopy(int index, double d)
        {
            switch (index)
            {
                case 0: return new PointD5D(_X + d, _Y, _Z, _U, _V);
                case 1: return new PointD5D(_X, _Y + d, _Z, _U, _V);
                case 2: return new PointD5D(_X, _Y, _Z + d, _U, _V);
                case 3: return new PointD5D(_X, _Y, _Z, _U + d, _V);
                case 4: return new PointD5D(_X, _Y, _Z, _U, _V + d);
                default: throw new IndexOutOfRangeException(nameof(index));
            }
        }
        ...
        public PointD5D ScaleCopy(int index, double s)
        {
            switch (index)
            {
                case 0: return new PointD5D(_X * s, _Y, _Z, _U, _V);
                case 1: return new PointD5D(_X, _Y * s, _Z, _U, _V);
                case 2: return new PointD5D(_X, _Y, _Z * s, _U, _V);
                case 3: return new PointD5D(_X, _Y, _Z, _U * s, _V);
                case 4: return new PointD5D(_X, _Y, _Z, _U, _V * s);
                default: throw new IndexOutOfRangeException(nameof(index));
            }
        }
        ...
        public PointD5D ShearCopy(int index1, int index2, double angle) => FromVector(ToColumnVector().ShearCopy(index1, index2, angle));
        ...
        public PointD5D RotateCopy(int index1, int index2, double angle) => FromVector(ToColumnVector().RotateCopy(index1, index2, angle));
        ...
        public PointD5D MatrixTransformCopy(Matrix matrixLeft) => FromVector(ToColumnVector().MatrixTransformCopy(matrixLeft));
        ...
        public PointD5D AffineTransformCopy(AffineTransformation affineTransformation) => FromVector(ToColumnVector().AffineTransformCopy(affineTransformation));
        ...
        /// <returns>PointD5D 结构，表示按 Matrix 对象表示的 6x6 仿射矩阵（左矩阵）将此 PointD5D 结构进行仿射变换得到的结果。</returns>
        [Obsolete("请改为使用 MatrixTransformCopy(Matrix) 方法")]
        public PointD5D AffineTransformCopy(Matrix matrixLeft) => FromVector(ToColumnVector().AffineTransformCopy(matrixLeft));
        ...
        public PointD5D AffineTransformCopy(params Matrix[] matricesLeft) => FromVector(ToColumnVector().AffineTransformCopy(matricesLeft));
        ...
        [Obsolete("请改为使用 AffineTransformCopy(AffineTransformation) 方法")]
        public PointD5D AffineTransformCopy(List<Matrix> matricesLeft) => FromVector(ToColumnVector().AffineTransformCopy(matricesLeft));
        ...
        [Obsolete("请改为使用 AffineTransformCopy(AffineTransformation) 方法")]
        public PointD5D InverseAffineTransformCopy(Matrix matrixLeft) => FromVector(ToColumnVector().InverseAffineTransformCopy(matrixLeft));
        ...
        [Obsolete("请改为使用 AffineTransformCopy(AffineTransformation) 方法")]
        public PointD5D InverseAffineTransformCopy(params Matrix[] matricesLeft) => FromVector(ToColumnVector().InverseAffineTransformCopy(matricesLeft));
        ...
        [Obsolete("请改为使用 AffineTransformCopy(AffineTransformation) 方法")]
        public PointD5D InverseAffineTransformCopy(List<Matrix> matricesLeft) => FromVector(ToColumnVector().InverseAffineTransformCopy(matricesLeft));
        ...
        public Vector ToColumnVector() => Vector.UnsafeCreateInstance(VectorType.ColumnVector, _X, _Y, _Z, _U, _V);

        /// <summary>
        /// 返回将此 PointD5D 结构转换为行向量的 Vector 的新实例。
        /// </summary>
        /// <returns>Vector 对象，表示将此 PointD5D 结构转换为行向量得到的结果。</returns>
        public Vector ToRowVector() => Vector.UnsafeCreateInstance(VectorType.RowVector, _X, _Y, _Z, _U, _V);
        ...
        public static PointD5D FromVector(Vector vector)
        {
            ...
            return new PointD5D(vector.UnsafeGetData()[0], vector.UnsafeGetData()[1], vector.UnsafeGetData()[2], vector.UnsafeGetData()[3], vector.UnsafeGetData()[4]);
        }
        ...
        public static Matrix OffsetMatrix(double dx, double dy, double dz, double du, double dv) => Vector.OffsetMatrix(Vector.UnsafeCreateInstance(VectorType.ColumnVector, dx, dy, dz, du, dv));
        ...
        public static Matrix ScaleMatrix(double sx, double sy, double sz, double su, double sv) => Vector.ScaleMatrix(Vector.UnsafeCreateInstance(VectorType.ColumnVector, sx, sy, sz, su, sv));
        ...
        /// <returns>布尔值，表示两个 PointD5D 结构是否相等。</returns>
        public static bool operator ==(PointD5D left, PointD5D right) => left._X == right._X && left._Y == right._Y && left._Z == right._Z && left._U == right._U && left._V == right._V;
        ...
        public static PointD5D operator +(PointD5D pt) => pt;
        ...
        public static PointD5D operator -(PointD5D pt) => new PointD5D(-pt._X, -pt._Y, -pt._Z, -pt._U, -pt._V);
        ...
        public static PointD5D operator +(PointD5D pt, double n) => new PointD5D(pt._X + n, pt._Y + n, pt._Z + n, pt._U + n, pt._V + n);
        ...
        public static PointD5D operator +(double n, PointD5D pt) => new PointD5D(n + pt._X, n + pt._Y, n + pt._Z, n + pt._U, n + pt._V);
        ...
        public static PointD5D operator +(PointD5D left, PointD5D right) => new PointD5D(left._X + right._X, left._Y + right._Y, left._Z + right._Z, left._U + right._U, left._V + right._V);
        ...
        public static implicit operator PointD5D((double X, double Y, double Z, double U, double V) tuple) => new PointD5D(tuple.X, tuple.Y, tuple.Z, tuple.U, tuple.V);
        ...
        public static implicit operator (double X, double Y, double Z, double U, double V)(PointD5D pt) => (pt._X, pt._Y, pt._Z, pt._U, pt._V);
