...
namespace Com
{
    ...
    public struct PointD6D : IEquatable<PointD6D>, IComparable, IComparable<PointD6D>, IEuclideanVector<PointD6D>, IAffine<PointD6D>
    {
        ...
        /// <summary>
        /// 从指定的索引开始遍历此 PointD6D 结构的所有分量并返回第一个与指定值相等的索引。
        /// </summary>
        /// <param name="item">用于检索的值。</param>
        ...
        /// <summary>
        /// 从指定的索引开始遍历此 PointD6D 结构指定数量的分量并返回第一个与指定值相等的索引。
        /// </summary>
        /// <param name="item">用于检索的值。</param>
        /// <param name="startIndex">起始索引。</param>
        ...
        /// <summary>
        /// 从指定的索引开始逆序遍历此 PointD6D 结构的所有分量并返回第一个与指定值相等的索引。
        /// </summary>
        /// <param name="item">用于检索的值。</param>
        /// <param name="startIndex">起始索引。</param>
        /// <returns>32 位整数，表示第一个与指定值相等的索引。</returns>
        ...
        /// <summary>
        /// 从指定的索引开始逆序遍历此 PointD6D 结构指定数量的分量并返回第一个与指定值相等的索引。
        /// </summary>
        /// <param name="item">用于检索的值。</param>
        /// <param name="startIndex">起始索引。</param>
        /// <param name="count">遍历的分量数量。</param>
        ...
        /// <summary>
        /// 判断两个 PointD6D 结构的模是否前者小于后者。
        /// </summary>
        /// <param name="left">运算符左侧比较的 PointD6D 结构。</param>
        /// <param name="right">运算符右侧比较的 PointD6D 结构。</param>
        /// <returns>布尔值，表示两个 PointD6D 结构的模是否前者小于后者。</returns>
        public static bool operator <(PointD6D left, PointD6D right)
        {
        ...
        /// <summary>
        /// 判断两个 PointD6D 结构的模是否前者大于后者。
        /// </summary>
        /// <param name="left">运算符左侧比较的 PointD6D 结构。</param>
        /// <param name="right">运算符右侧比较的 PointD6D 结构。</param>
        /// <returns>布尔值，表示两个 PointD6D 结构的模是否前者大于后者。</returns>
        public static bool operator >(PointD6D left, PointD6D right)
        {
            return (left.Module > right.Module);
        }
        ...
        /// <summary>
        /// 判断两个 PointD6D 结构的模是否前者小于或等于后者。
        /// </summary>
        /// <param name="left">运算符左侧比较的 PointD6D 结构。</param>
        /// <param name="right">运算符右侧比较的 PointD6D 结构。</param>
        /// <returns>布尔值，表示两个 PointD6D 结构的模是否前者小于或等于后者。</returns>
        public static bool operator <=(PointD6D left, PointD6D right)
        {
            return (left.Module <= right.Module);
        }
        ...
        /// <summary>
        /// 判断两个 PointD6D 结构的模是否前者大于或等于后者。
        /// </summary>
        /// <param name="left">运算符左侧比较的 PointD6D 结构。</param>
        /// <param name="right">运算符右侧比较的 PointD6D 结构。</param>
        /// <returns>布尔值，表示两个 PointD6D 结构的模是否前者大于或等于后者。</returns>
        public static bool operator >=(PointD6D left, PointD6D right)
        {
            return (left.Module >= right.Module);
        }
