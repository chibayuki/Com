...
namespace Com
{
    ...
    public struct PointD3D : IEquatable<PointD3D>, IComparable, IComparable<PointD3D>, IEuclideanVector<PointD3D>, IAffineTransformable<PointD3D>, IAffine<PointD3D>
    {
        ...
        public override string ToString() => string.Concat("{X=", _X, ", Y=", _Y, ", Z=", _Z, "}");
        ...
        public void MatrixTransform(Matrix matrixLeft)
        {
            Vector result = ToColumnVector().MatrixTransformCopy(matrixLeft);
        ...
        public PointD3D MatrixTransformCopy(Matrix matrixLeft)
        {
            Vector result = ToColumnVector().MatrixTransformCopy(matrixLeft);
        ...
        public PointD3D AffineTransformCopy(AffineTransformation affineTransformation)
        {
            Vector result = ToColumnVector().AffineTransformCopy(affineTransformation);
        ...
        public Vector ToColumnVector() => Vector.UnsafeCreateInstance(Vector.Type.ColumnVector, _X, _Y, _Z);

        /// <summary>
        /// 返回将此 PointD3D 结构转换为行向量的 Vector 的新实例。
        /// </summary>
        /// <returns>Vector 对象，表示将此 PointD3D 结构转换为行向量得到的结果。</returns>
        public Vector ToRowVector() => Vector.UnsafeCreateInstance(Vector.Type.RowVector, _X, _Y, _Z);
        ...
        public static Matrix OffsetMatrix(double dx, double dy, double dz) => Vector.OffsetMatrix(Vector.UnsafeCreateInstance(Vector.Type.ColumnVector, dx, dy, dz));
        ...
        public static Matrix OffsetXMatrix(double d) => Vector.OffsetMatrix(Vector.UnsafeCreateInstance(Vector.Type.ColumnVector, d, 0, 0));
        ...
        public static Matrix OffsetYMatrix(double d) => Vector.OffsetMatrix(Vector.UnsafeCreateInstance(Vector.Type.ColumnVector, 0, d, 0));
        ...
        public static Matrix OffsetZMatrix(double d) => Vector.OffsetMatrix(Vector.UnsafeCreateInstance(Vector.Type.ColumnVector, 0, 0, d));
        ...
        public static Matrix ScaleMatrix(double sx, double sy, double sz) => Vector.ScaleMatrix(Vector.UnsafeCreateInstance(Vector.Type.ColumnVector, sx, sy, sz));
        ...
        public static Matrix ScaleXMatrix(double s) => Vector.ScaleMatrix(Vector.UnsafeCreateInstance(Vector.Type.ColumnVector, s, 0, 0));
        ...
        public static Matrix ScaleYMatrix(double s) => Vector.ScaleMatrix(Vector.UnsafeCreateInstance(Vector.Type.ColumnVector, 0, s, 0));
        ...
        public static Matrix ScaleZMatrix(double s) => Vector.ScaleMatrix(Vector.UnsafeCreateInstance(Vector.Type.ColumnVector, 0, 0, s));
