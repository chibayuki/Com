...
namespace Com
{
    ...
    public struct TimeSpanX : IEquatable<TimeSpanX>, IComparable, IComparable<TimeSpanX>
    {
        ...
        public TimeSpanX(decimal totalMilliseconds)
        {
        ...
        public TimeSpanX(int hours, int minutes, int seconds)
        {
            _TotalMilliseconds = _CheckTotalMilliseconds(hours * _MillisecondsPerHour + minutes * _MillisecondsPerMinute + seconds * _MillisecondsPerSecond);
        }
        ...
        /// <param name="minutes">32 位整数表示的分钟数。</param>
        /// <param name="seconds">32 位整数表示的秒数。</param>
        public TimeSpanX(long days, int hours, int minutes, int seconds)
        {
            _TotalMilliseconds = _CheckTotalMilliseconds((decimal)days * _MillisecondsPerDay + hours * _MillisecondsPerHour + minutes * _MillisecondsPerMinute + seconds * _MillisecondsPerSecond);
        }
        ...
        public TimeSpanX(long days, int hours, int minutes, int seconds, int milliseconds)
        {
            _TotalMilliseconds = _CheckTotalMilliseconds((decimal)days * _MillisecondsPerDay + hours * _MillisecondsPerHour + minutes * _MillisecondsPerMinute + seconds * _MillisecondsPerSecond + milliseconds);
        }
        ...
        public TimeSpanX(TimeSpan timeSpan)
        {
            _TotalMilliseconds = _CheckTotalMilliseconds((decimal)timeSpan.TotalMilliseconds);
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            else if (obj is null || !(obj is TimeSpanX))
            {
                return false;
            }
            else
        ...
        public static TimeSpanX operator +(TimeSpanX timeSpan)
        {
            return timeSpan;
        }
        ...
        public static TimeSpanX operator -(TimeSpanX timeSpan)
        {
            return new TimeSpanX(-timeSpan._TotalMilliseconds);
        }
        ...
        public static implicit operator TimeSpanX(TimeSpan timeSpan)
        {
            return new TimeSpanX(timeSpan);
        }
