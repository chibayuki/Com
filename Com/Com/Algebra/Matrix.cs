...
namespace Com
{
    ...
    public sealed class Matrix : IEquatable<Matrix>
    {
        ...
        public double this[Point index]
        {
            get
            {
                if ((index.X < 0 || index.X >= _Size.Width) || (index.Y < 0 || index.Y >= _Size.Height))
                {
        ...
        /// 获取此 Matrix 的行数（高度）。
        /// </summary>
        public int Row => _Size.Height;

        /// <summary>
        /// 获取此 Matrix 包含的元素数量。
        /// </summary>
        public int Count => _Size.Width * _Size.Height;
        ...
        public override string ToString()
        {
            ...
            {
                str = $"Column={_Size.Width}, Row={_Size.Height}";
            }
        ...
        public Matrix SubMatrix(Point index, Size size)
        {
            ...
            if ((index.X < 0 || index.X + size.Width > _Size.Width) || (index.Y < 0 || index.Y + size.Height > _Size.Height))
            {
                throw new IndexOutOfRangeException(nameof(index));
            }
        ...
        public Matrix SubMatrix(int x, int y, int width, int height)
        {
            ...
            if (x < 0 || x + width > _Size.Width)
            {
                throw new ArgumentOutOfRangeException(nameof(x));
            }

            if (y < 0 || y + height > _Size.Height)
            {
        ...
        public Vector GetColumn(int x)
        {
            ...
            return Vector.UnsafeCreateInstance(VectorType.ColumnVector, values);
        }
        ...
        public Vector GetRow(int y)
        {
            ...
            return Vector.UnsafeCreateInstance(VectorType.RowVector, values);
        }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        return Vector.UnsafeCreateInstance(VectorType.ColumnVector, result);
                    }
                }
            }
        }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        return Vector.UnsafeCreateInstance(VectorType.RowVector, result);
                    }
                }
            }
        }
